  ...
  return (
    <section id="hero" className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        <div className="mb-4">
          <p className="font-vibes text-2xl md:text-4xl text-gold-accent mb-2">
            Khaled &amp; Rola
          </p>
          <div className="flex items-center justify-center gap-3">
            <div className="w-12 h-px bg-gold-accent/60" />
            <Heart className="w-4 h-4 text-deep-rose" fill="currentColor" />
            <div className="w-12 h-px bg-gold-accent/60" />
          </div>
        </div>
