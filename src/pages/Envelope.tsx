        ...
        {showLetter && (
          ...
          >
            ...
            <div className="text-center">
              <p className="font-amiri text-lg md:text-xl text-deep-rose font-bold mb-3 md:mb-4">
                Khaled &amp; Rola
              </p>
              <p className="font-amiri text-base md:text-xl text-dark-plum leading-relaxed mb-3 md:mb-4">
                حبيبتي و أغلى حاجة ف حياتي، عايز أقولك كلمتين كده همّا ميدوكيش حقك بس دا كل اللي أقدر أعمله عشان أديكي ربع حقك.
              </p>
              <p className="font-amiri text-base md:text-xl text-dark-plum leading-relaxed mb-3 md:mb-4">
                انتي أجمل وأطيب قلب ف الدنيا كلها، مش عايزك تزعلي مني، انتي عارفه إن مش قصدي وعارفة انتي إيه بالنِسبالي.
              </p>
              <p className="font-amiri text-base md:text-xl text-dark-plum leading-relaxed mb-3 md:mb-4">
                ربنا يخليكي ليا يا حبيبة قلبي، ونفضل مع بعض طول العمر ومنفترقش أبداً.
              </p>
              <p className="font-amiri text-base md:text-xl text-dark-plum leading-relaxed mb-3 md:mb-4">
                يارب تفضلي علطول فرحانة ومبسوطة ومفيش أي حاجة تزعلك أبداً.
              </p>
              <p className="font-amiri text-base md:text-xl text-dark-plum leading-relaxed mb-3 md:mb-4">
                ربنا يجعلنا من نصيب بعض ومفيش حاجة تحصل تفرّقنا عن بعض إن شاء الله.
              </p>
              <p className="font-amiri text-base md:text-xl text-dark-plum leading-relaxed mb-4 md:mb-6">
                بحبك يا أحلى حاجة ف حياتي ♥️
              </p>

              <div className="mt-4 md:mt-6 pt-3 md:pt-4 border-t border-gold-accent/30">
                <p className="font-cairo text-base md:text-lg text-deep-rose font-bold">
                  بحبك يا رولا
                </p>
                <p className="font-cairo text-xs text-dusty-mauve mt-1">
                  من كل قلبي - خالد
                </p>
              </div>
            </div>
